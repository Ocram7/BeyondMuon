# GPT-2 124M OpenWebText config: AdamQ, p = 1/4.
# $ torchrun --standalone --nproc_per_node=8 train.py config/gpt-124M-NS/AdamQ.py

# experiment-specific settings
tb_run_name = 'gpt2-124M-AdamQ'
optimizer_variant = "AdamQ"
