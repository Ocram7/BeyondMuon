# GPT-2 124M OpenWebText config: mSGD, p = 1.
# $ torchrun --standalone --nproc_per_node=8 train.py config/gpt-124M-NS/mSGD.py

# experiment-specific settings
tb_run_name = 'gpt2-124M-mSGD'
optimizer_variant = "mSGD"
