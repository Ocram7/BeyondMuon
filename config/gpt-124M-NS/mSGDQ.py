# GPT-2 124M OpenWebText config: mSGDQ, p = 1/4.
# $ torchrun --standalone --nproc_per_node=8 train.py config/gpt-124M-NS/mSGDQ.py

# experiment-specific settings
tb_run_name = 'gpt2-124M-mSGDQ'
optimizer_variant = "mSGDQ"
