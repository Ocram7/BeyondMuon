# GPT-2 124M OpenWebText config: mSGDS, p = 1/2.
# $ torchrun --standalone --nproc_per_node=8 train.py config/gpt-124M-NS/mSGDS.py

# experiment-specific settings
tb_run_name = 'gpt2-124M-mSGDS'
optimizer_variant = "mSGDS"
