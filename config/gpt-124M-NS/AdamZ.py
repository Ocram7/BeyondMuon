# GPT-2 124M OpenWebText config: AdamZ, p = 0.
# $ torchrun --standalone --nproc_per_node=8 train.py config/gpt-124M-NS/AdamZ.py

# experiment-specific settings
tb_run_name = 'gpt2-124M-AdamZ'
optimizer_variant = "AdamZ"
